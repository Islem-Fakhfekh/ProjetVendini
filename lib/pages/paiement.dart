...
import 'package:vendini/pages/vendeur.dart'; // Import the vendeur.dart page
...
class _PaymentScreenState extends State<PaymentScreen> {
  String? selectedPaymentMethod = 'Paiement à la livraison'; // Default option
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Container(
        height: double.infinity, // Covers full height
      ...
      children: [
        IconButton(
          ...
          onPressed: () {
            ...
            ); // Navigate explicitly to the cart page
          },
        ),
                ...
                children: [
                  GestureDetector(
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => const VendeurPage()), // Navigate to VendeurPage
                      );
                    },
